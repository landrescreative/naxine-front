...
export default function NuestrasGarantias() {
  ...
  return (
    <section className="relative w-full py-16 px-4 sm:px-6 md:px-10 lg:px-[80px] bg-white overflow-hidden">
      ...
      <div className="absolute top-20 right-20 w-40 h-40 opacity-90 transform translate-x-12 -translate-y-12">
        <img
      ...
      <div className="absolute bottom-20 right-20 w-32 h-20 opacity-90 transform translate-x-16 translate-y-8">
        <img
          src={dotsCircle.src}
