...
export default function PagosPage() {
  const rows = Array.from({ length: 10 }).map((_, idx) => ({
    id: String(idx + 1),
    professional: { specialty: "Nutriologa", name: "Carmen Leandra" },
    date: "Dic 23, 2024",
    amount: "USD $12.00",
  ...
  return (
    <div className="space-y-8">
      {/* Summary (optional, keep minimal to match screenshot spacing) */}
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-white">$2,450</dd>
                </dl>
              </div>
            </div>
          </div>
      ...
      {/* Payments Table matching reference */}
      <ProfessionalPaymentsTable rows={rows} />
    </div>
  );
}
